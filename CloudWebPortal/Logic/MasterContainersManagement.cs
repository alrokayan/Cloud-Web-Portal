...
namespace CloudWebPortal.Logic
{
    public class MasterContainersManagement : ContainersManagement
    {
        ...
        public void buildExistMaster(Aneka.Runtime.Configuration configure, ContainerProperty property)
        {
            try
            {
        ...
        {
            CloudWebPortal.Models.Cloud cloud = db.Clouds.Find(cloudID);

            try
            {
                CloudWebPortal.Models.Machine machine = machineLookupFromMasterId(cloud.Master.MasterId);
                ...
                byte[] key = Aneka.Security.Cryptography.AESCryptoUtil.GenerateKey();
               ...
               // String NewSecuritySharedKey = "whM2IcwXiQzmVbDyvOnOmPxgUS6WRp+VKVYuThtVuiM=";
                ...
                CloudWebPortal.Models.Cloud cloudFromDB = db.Clouds.Find(cloudID);
            ...
            {
                Master masterFromDB = db.Masters.Find(cloud.Master.MasterId);
                masterFromDB.StatusEnum = Aneka.UI.Configuration.ProbeStatus.Error;
