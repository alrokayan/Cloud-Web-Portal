...
namespace CloudWebPortal.Logic
{
    public class AnekaUsersManagement
    {
        ...
        private global::Aneka.UI.Security.SecurityManager securityManager = null;

        public AnekaUsersManagement(Uri serviceUri, UserCredentials userCredentials)
        {
            securityManager = new global::Aneka.UI.Security.SecurityManager(serviceUri, userCredentials);
        }
