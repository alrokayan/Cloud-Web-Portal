    ...
    public class ContainersManagement
    {
            ...
            String MasterBackupUri)//For master only
        {
            try
            {
                ...
                configuration.Container.BuiltInSecurityMode = global::Aneka.Management.Config.BuiltInSecurityMode.ANEKA;
                ...
                if (isMaster)
                {
                    services.Add("ReportingService", new global::Aneka.Management.Config.Entity.ReportingServiceConfigureProperty());
                    services.Add("ResourceProvisioningService", new global::Aneka.Management.Config.Entity.ResourceProvisioningServiceConfigureProperty());
                    services.Add("TaskScheduler", new global::Aneka.Management.Config.TaskSchedulingServiceConfigureProperty());
                    services.Add("ThreadScheduler", new global::Aneka.Management.Config.ThreadSchedulingServiceConfigureProperty());
                    services.Add("MapReduceScheduler", new global::Aneka.Management.Config.Entity.MapReduceSchedulingServiceConfigureProperty());
                    services.Add("StorageService", new global::Aneka.Management.Config.Entity.StorageServiceConfigureProperty());
                }
                services.Add("LoggingService", new global::Aneka.Management.Config.Entity.LoggingServiceConfigureProperty());
                services.Add("MonitoringService", new global::Aneka.Management.Config.Entity.MonitoringServiceConfigureProperty());
                services.Add("DiscoveryService", new global::Aneka.Management.Config.Entity.DiscoveryServiceConfigureProperty());
                services.Add("TaskExecutionService", new global::Aneka.Management.Config.Entity.TaskExecutionServiceConfigurableProperty());
                services.Add("ThreadExecutionService", new global::Aneka.Management.Config.Entity.ThreadExecutionServiceConfigurableProperty());
                services.Add("MapReduceExecutor", new global::Aneka.Management.Config.Entity.MapReduceExecutionServiceConfigureProperty());
                    ...
                    foreach (Service service in Services)
                    {
                        try
                        {
                            if (service.SpringSegmentXML == "<HardCoded>LoggingService</HardCoded>")
                                requiredServices.Add("LoggingService", new global::Aneka.Management.Config.Entity.LoggingServiceConfigureProperty());
                            if (service.SpringSegmentXML == "<HardCoded>MonitoringService</HardCoded>")
                                requiredServices.Add("MonitoringService", new global::Aneka.Management.Config.Entity.MonitoringServiceConfigureProperty());
                            if (service.SpringSegmentXML == "<HardCoded>DiscoveryService</HardCoded>")
                                requiredServices.Add("DiscoveryService", new global::Aneka.Management.Config.Entity.DiscoveryServiceConfigureProperty());
                            if (service.SpringSegmentXML == "<HardCoded>TaskExecutionService</HardCoded>")
                                requiredServices.Add("TaskExecutionService", new global::Aneka.Management.Config.Entity.TaskExecutionServiceConfigurableProperty());
                            if (service.SpringSegmentXML == "<HardCoded>ThreadExecutionService</HardCoded>")
                                requiredServices.Add("ThreadExecutionService", new global::Aneka.Management.Config.Entity.ThreadExecutionServiceConfigurableProperty());
                            if (service.SpringSegmentXML == "<HardCoded>MapReduceExecutor</HardCoded>")
                                requiredServices.Add("MapReduceExecutor", new global::Aneka.Management.Config.Entity.MapReduceExecutionServiceConfigureProperty());

                            //Master Only Services
                            if (isMaster)
                            {
                                if (service.SpringSegmentXML == "<HardCoded>ReportingService</HardCoded>")
                                    requiredServices.Add("ReportingService", new global::Aneka.Management.Config.Entity.ReportingServiceConfigureProperty());
                                if (service.SpringSegmentXML == "<HardCoded>ResourceProvisioningService</HardCoded>")
                                    requiredServices.Add("ResourceProvisioningService", new global::Aneka.Management.Config.Entity.ResourceProvisioningServiceConfigureProperty());
                                if (service.SpringSegmentXML == "<HardCoded>TaskScheduler</HardCoded>")
                                    requiredServices.Add("TaskScheduler", new global::Aneka.Management.Config.TaskSchedulingServiceConfigureProperty());
                                if (service.SpringSegmentXML == "<HardCoded>ThreadScheduler</HardCoded>")
                                    requiredServices.Add("ThreadScheduler", new global::Aneka.Management.Config.ThreadSchedulingServiceConfigureProperty());
                                if (service.SpringSegmentXML == "<HardCoded>MapReduceScheduler</HardCoded>")
                                    requiredServices.Add("MapReduceScheduler", new global::Aneka.Management.Config.Entity.MapReduceSchedulingServiceConfigureProperty());
                                if (service.SpringSegmentXML == "<HardCoded>StorageService</HardCoded>")
                                    requiredServices.Add("StorageService", new global::Aneka.Management.Config.Entity.StorageServiceConfigureProperty());
                            }
                        }
                        catch (Exception)
                        {
        ...
        public CloudWebPortal.Areas.Aneka.Models.Machine machineLookupFromMasterId(int masterID)
        {
            CloudWebPortal.Areas.Aneka.Models.Machine machine = null;
            foreach (CloudWebPortal.Areas.Aneka.Models.Machine m in db.Machines.ToList())
            {
                foreach (Master master in m.Masters)
