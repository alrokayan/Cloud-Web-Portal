...
{
    public class AnekaDbContext : DbContext
    {
        ...
        public DbSet<CloudWebPortal.Areas.Aneka.Models.Machine> Machines { get; set; }
    ...
    public class AnekaDbInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<AnekaDbContext>
    {
        protected override void Seed(AnekaDbContext context)
        {
            ...
            context.ResourcePools.Add(new ResourcePool { ResourcePoolDisplayName = "Default", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>() });
            context.SaveChanges();
            ...
            {
                new MachineLoginCredential{ Username= "gridadm", Password="xxxxx", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()},
                new MachineLoginCredential{ Username= "alrokayan", Password="xxxxx", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()}
            };
            MachineLoginCredentials.ForEach(s => context.MachineLoginCredentials.Add(s));
            context.SaveChanges();
            
            
            var Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>
            {
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Manjra Server", IP = "192.168.1.100",  Platform=MachinePlatforms[0],   Type=MachineTypes[0],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Lab PC10",      IP = "192.168.1.159",  Platform=MachinePlatforms[1],   Type=MachineTypes[1],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Lab PC11",      IP = "192.168.1.101",  Platform=MachinePlatforms[0],   Type=MachineTypes[1],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Lab PC12",      IP = "192.168.1.120",  Platform=MachinePlatforms[0],   Type=MachineTypes[0],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Lab PC13",      IP = "192.168.1.10",   Platform=MachinePlatforms[0],   Type=MachineTypes[1],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="UniMelb Lab PC14",      IP = "192.168.1.18",   Platform=MachinePlatforms[1],   Type=MachineTypes[1],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="EC2 Server for the Uni",IP = "29.20.100.100",  Platform=MachinePlatforms[1],   Type=MachineTypes[2],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()},
                new CloudWebPortal.Areas.Aneka.Models.Machine { DisplayName="MS Azure for the Uni",  IP = "80.22.18.8",     Platform=MachinePlatforms[0],   Type=MachineTypes[3],   StatusEnum=DaemonProbeStatus.Unknown, Workers = new List<Worker>(), Masters = new List<Master>(), SoftwareAppliances = new List<SoftwareAppliance>()}
            };
            ...
            {
                new ResourcePool { ResourcePoolDisplayName="Lab12", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()},
                new ResourcePool { ResourcePoolDisplayName="EC2", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()}
            };
            ...
            {
                new SoftwareAppliance { Name="POV-Ray", Vendor="Persistence of Vision Ray Tracer Pty. Ltd.", Version="3.1", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()},
                new SoftwareAppliance { Name="Demo App", Vendor="Demo Pty. Ltd.", Version="8.1", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()},
                new SoftwareAppliance { Name="CAD", Vendor="Unknown Pty. Ltd.", Version="0.1", Machines = new List<CloudWebPortal.Areas.Aneka.Models.Machine>()}
            };
